...
mod tests {
    ...
    fn sqlite_type_integer() {
        assert!(matches!(
            sqlite_to_tds_type(Some("INTEGER")),
            TdsType::BigInt
        ));
    }
    ...
    fn sqlite_type_bigint() {
        assert!(matches!(
            sqlite_to_tds_type(Some("BIGINT")),
            TdsType::BigInt
        ));
    }
    ...
    fn sqlite_type_boolean() {
        assert!(matches!(
            sqlite_to_tds_type(Some("BOOLEAN")),
            TdsType::BigInt
        ));
    }
    ...
    fn sqlite_type_double() {
        assert!(matches!(
            sqlite_to_tds_type(Some("DOUBLE")),
            TdsType::Float8
        ));
    }
    ...
    fn sqlite_type_varchar() {
        assert!(matches!(
            sqlite_to_tds_type(Some("VARCHAR")),
            TdsType::NVarChar
        ));
    }
    ...
    fn sqlite_type_binary() {
        assert!(matches!(
            sqlite_to_tds_type(Some("BINARY")),
            TdsType::VarBinary
        ));
    }
    ...
    fn sqlite_type_unknown_defaults_to_nvarchar() {
        assert!(matches!(
            sqlite_to_tds_type(Some("DATE")),
            TdsType::NVarChar
        ));
        assert!(matches!(
            sqlite_to_tds_type(Some("TIMESTAMP")),
            TdsType::NVarChar
        ));
        assert!(matches!(
            sqlite_to_tds_type(Some("JSON")),
            TdsType::NVarChar
        ));
    }
    ...
    fn value_type_integer() {
        assert!(matches!(
            value_to_tds_type(&Value::Integer(42)),
            TdsType::BigInt
        ));
    }
    ...
    fn value_type_float() {
        assert!(matches!(
            value_to_tds_type(&Value::Float(2.5)),
            TdsType::Float8
        ));
    }
